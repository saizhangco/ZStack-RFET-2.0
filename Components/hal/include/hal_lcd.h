...
extern void TakeMedicine(unsigned char amount);
extern void AddMedicine(unsigned char amount);
extern void QueryMedicine(unsigned char amount);
extern void MedicineBusinessEnd(void);
/**************************************************************************************************
**************************************************************************************************/
